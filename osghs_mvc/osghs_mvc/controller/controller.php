<?php
	...
	class controller{
		...
		function index(){
			...
			include ('osghs_mvc\view\Main\view_search.php'); //memamnggil view.php pada folder view
		}
		
		function view_search(){
			$data = $this->model->selectAll(); 
			include ('osghs_mvc\view\Main\view_search.php');
		}

		function login(){
			$data = $this->model->selectAll(); 
			include ('osghs_mvc\view\Main\Admin\view-login.php');
		}
