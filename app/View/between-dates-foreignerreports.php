                            ...
                            <div class="col-12 mt-5">
                                <div class="card">
                                    <div class="card-body"> <h4 class="header-title" style="color: blue">Between Dates Reports of Ticket Generating</h4>
                                        ...
                                        <form method="POST" name="bwdatesreport" action="viewForeignerReport">
                                         ...
                                         <div class="form-group">
                                            ...
                                            <button type="submit" class="btn btn-primary mt-4 pr-4 pl-4" name="submitViewForeignerReport">Submit</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
