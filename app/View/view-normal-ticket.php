...
?>
                                        <h4 class="header-title" style="color: blue">View Detail of Ticket ID: <?php  echo $ticketDetail['TicketID'];?></h4>
                                        <h5 class="header-title" style="color: blue">Visiting Date: <?php  echo $ticketDetail['PostingDate'];?></h5>
                                ...
                                <tr>
                                    ...
                                    <td style="padding-left: 10px"><?php  echo $noadult=$ticketDetail['NoAdult'];?></td>
                                     <td style="padding-left: 10px">$<?php  echo $cup=$ticketDetail['AdultUnitprice'];?></td>
                                     <td style="padding-left: 10px">$<?php  echo $ta=$cup*$noadult;?></td>
                                </tr>
                                <tr>
                                    <th>Number of Chlidren </th>
                                    <td style="padding-left: 10px"><?php  echo $nochild=$ticketDetail['NoChildren'];?></td>
                                    <td style="padding-left: 10px">$<?php  echo $aup=$ticketDetail['ChildUnitprice'];?></td>
