                            ...
                            <div class="col-12 mt-5">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form method="POST" name="bwdatesreport" action="/viewNormalReport">
                                         ...
                                         <div class="form-group">
                                            ...
                                            <button type="submit" class="btn btn-primary mt-4 pr-4 pl-4" name="submitViewNormalReport">Submit</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
