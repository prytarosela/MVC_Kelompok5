            ...
            <div class="main-content-inner">
                <div class="row">
                    ...
                    <div class="col-12 mt-5">
                        <div class="card">
                            <div class="card-body">
                                <form id="basic-form" method="POST" action="/searchNormalTicketData">
                                ...
                                <br>
                                <button type="submit" class="btn btn-primary" name="submitSearchNormalTicketData" id="submit">Search</button>
                            </form>  
